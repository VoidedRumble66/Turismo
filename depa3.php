...
?>
    ...
    <div class="detalles-container">
        <div class="galeria">
            <img src="img/dep34.webp" alt="Departamento Barrio Bonampak" class="imagen-principal">
            <div class="miniaturas">
              <img src="img/dep21.webp" alt="Sala" class="miniatura">
              <img src="img/dep22.webp" alt="Cocina" class="miniatura">
              <img src="img/dep23.webp" alt="Baño" class="miniatura">
              <img src="img/dep34.webp" alt="Habitación" class="miniatura">
            </div>
        </div>

        <div class="detalles-info">
            <h1 class="detalles-titulo">Departamento en Barrio Centro</h1>
            <p class="precio-detalle">$1500 MXN / mes</p>
            
            <div class="detalles-descripcion">
                <p>Hermoso departamento ubicado en el corazón del Barrio Candelaria, una de las zonas más seguras de Ocosingo al lado de krunhy pollo. Este acogedor espacio cuenta con todas las comodidades para hacer de tu estancia una experiencia inolvidable.</p>
    ...
    <div class="ubicacion-container">
        ...
        <div class="direccion">
            <h3>Dirección</h3>
            <p>Casa de Pollo, Barrio Centro</p>
    ...
    <div class="contacto-container">
        ...
        <div class="contacto-grid">
            <div class="propietario-info">
                <img src="img/jsl.jpeg" alt="Propietario" class="propietario-foto">
                <p class="propietario-nombre">Jose Luis</p>
